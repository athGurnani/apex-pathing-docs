...
* Imagine a coordinate plane where the $x$ axis is represented as $t$ and the $y$ axis is represented by $x$. This is the $x$ function's 'space'.function
...
/*section abt ghost points goes here :D*/